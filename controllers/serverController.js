...
const { uploadFileToS3 } = require("./s3Helper"); // S3 helper for file uploads

// -- Controller Functions -- //

// @desc generate trial balance
// @route GET /server/genTrialBal
// @access Private
const generateTrialBalance = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ message: "Failed to generate and upload PDF", error: error.message });
    }
});

// @desc generate income statement
// @route GET /server/genIncState
// @access Private
...
// @route GET /server/genEarningsStatement
// @access Private
